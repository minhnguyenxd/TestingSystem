...
namespace CrashTestScheduler.Entity.ViewModel
{
    public class CrashTestViewModel
    {
        ...
        [Display(Name = "Test Tech PIC")]
        public string TestTechPic { get; set; }

        [Display(Name = "Test Tech Phone")]
        public string TestTechPhone { get; set; }
        ...
        [Range(1, int.MaxValue, ErrorMessage = "Please choose a build level.")]
        public int? BuildLevelId { get; set; }


        public List<ChecklistTechnicianViewModel> TestTechnicians { get; set; }
        ...
        public int? TestLaboratoryName { get; set; }
        ...
        [Display(Name = "Joint Certification")]
        public bool JointCertification { get; set; }

        [Display(Name = "Vehicle Number")]
        public string VehicleNumber { get; set; }

        [Display(Name = "Vehicle Record")]
        ...
        public string BuildLevelName { get; set; }
        ...
        public string ManualTestPlanPath { get; set; }
        public string ManualPtcApprovalPath { get; set; }
        ...
        public string GetClassByTabId(int tabId, string className)
        {
            if (TabState.Any(x => x.TabId == tabId && x.Completed))
            {
                return "fa fa-check";
        ...
        public int PtcRequestStatus { get; set; }
    }
}