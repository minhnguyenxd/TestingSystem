...
namespace CrashTestScheduler.Entity.ViewModel
{
    public class SledTestViewModel
    {
        public SledTestViewModel()
        {
        ...
        [Required(ErrorMessage="Build Level Required.")]
        ...
        [Required]
        [Display(Name = "Sled Type")]
        [Range(1, int.MaxValue, ErrorMessage = "Please choose a Test type.")]
        public int? SledTypeId { get; set; }

        [Display(Name = "Sled Type")]
        public string SledTypeName { get; set; }
        ...
        [Display(Name = "Buck")]
        [Range(1, int.MaxValue, ErrorMessage = "Please choose a Test type.")]
        public int? SledBuckId { get; set; }

        [Display(Name = "Buck")]
        public string SledBuckName { get; set; }
