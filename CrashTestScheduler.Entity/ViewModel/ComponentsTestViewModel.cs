...
using CrashTestScheduler.Entity.Utils;
...
namespace CrashTestScheduler.Entity.ViewModel
{
    public class ComponentsTestViewModel
    {
        public ComponentsTestViewModel()
        {
        ...
        [Required(ErrorMessage = "Requested completion date is required")]
        ...
        [Range(1, int.MaxValue, ErrorMessage = "Please choose a development phase.")]
        ...
        [Required(ErrorMessage = "Select a test purpose")]
        public int? TestPurpose { get; set; }

        [Display(Name = "Development Stage")]
        [Required(ErrorMessage = "Select a development stage")]
